...
Type TLightmapper
	...
	Method Run:TPixmap(mesh:TMesh, lumelsize# = 0.5, coordset = 0)
		...
		For Local surface:TSurface = EachIn mesh
			...
			For Local i = 0 Until t
				...
				Select p.MajorAxis()
				Case AXIS_X
					CalculateUV surface,i,y0,z0,y1,z1,y2,z2,coordset,box
				...
				Case AXIS_Y
					CalculateUV surface,i,x0,z0,x1,z1,x2,z2,coordset,box
				...
				Case AXIS_Z
					CalculateUV surface,i,x0,y0,x1,y1,x2,y2,coordset,box
				...
				For Local x = 0 Until width 
					For Local y = 0 Until height
						...
						For Local light:TLMLight = EachIn lights
							...
							EndIf								
						Next	
						pixmap.WritePixel x,y,((255&$ff) Shl 24)|((Min(255, r)&$ff) Shl 16)|((Min(255, g)&$ff) Shl 8)|(Min(255, b)&$ff)
					Next
				Next
	...
	Method CalculateUV(surface:TSurface,index,u0#,v0#,u1#,v1#,u2#,v2#,coordset,box:TBoundingBox Var)	
